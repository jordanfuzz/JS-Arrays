...
function divider(numbersArray) {
    ...
    return [evenFinder(numbersArray), odds]
}
...
function both(arr1, arr2) {
    ...
    arr1.forEach(function(element, i) {
        if(arr2.includes(element) && !newArray.includes(element))
            newArray.push(element)
    })
    arr2.forEach(function(element,i) {
        if(arr1.includes(element) && !newArray.includes(element))
            newArray.push(element)
    })
    return newArray
}
...
let user2 = {
    name: 'Fuzzy Wuzzy',
    email: 'wuzzabear@gmail.com',
    password: 'iLoveHOTOatmeal',
    username: 'solidsnek'
}

let user3 = {
    name: 'Charles Darwin',
    email: 'species@origin.com',
    password: 'monkeystohumans6',
    username: 'megagladiatorboss1809'
}
